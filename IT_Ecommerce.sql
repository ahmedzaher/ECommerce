...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2016 at 02:06 PM
...
(24, '2015-08-23 05:12:23', 'K7627107 ', 'Calvin Klein K7627107 Post Minimal For Men (Analog, Dress Watch)', 11, 35, 'Watch', 'Calvin Klein', '1', 'imgs/products/K7627107.jpg'),
(25, '2015-08-23 05:13:34', 'K1V27820 ', 'Calvin Klein K1V27820 Drive Chronograph For Men (Analog, Casual Watch)', 10, 33, 'Watch', 'Calvin Klein', '1', 'imgs/products/K1V27820.jpg');
...
ALTER TABLE `order_product`
  ...
  ADD CONSTRAINT `order_product_ibfk_1` FOREIGN KEY (`transaction_id`) REFERENCES `order_processing` (`transaction_id`);
